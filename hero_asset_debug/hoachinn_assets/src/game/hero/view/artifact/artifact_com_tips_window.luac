...
function ArtifactComTipsWindow:open_callback(  )
    ...
    self.baseattr_panel:getChildByName("label"):setString(TI18N("语言_c_5230"))
    ...
    self.skill_panel:getChildByName("label"):setString(TI18N("语言_c_5231"))
...
function ArtifactComTipsWindow:setBaseInfo(  )
    ...
    self.equip_type:setString(TI18N("语言_c_1728")..item_config.type_desc)
end
