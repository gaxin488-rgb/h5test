...
BackPackConst.quality_color = {
  ...
  [6] = Config.ColorData.data_color4[286],     --金色
  [7] = Config.ColorData.data_color4[288],     --彩色
  [8] = Config.ColorData.data_color4[289],     --mr
}
...
BackPackConst.quality_3_color = {
  ...
  [6] = Config.ColorData.data_color3[286],     --金色
  [7] = Config.ColorData.data_color4[288],     --彩色
  [8] = Config.ColorData.data_color3[289],     --mr
}
...
BackPackConst.tips_btn_type = {
    ...
    use_skill = 47,       --使用封装的天赋技能
}

BackPackConst.tips_btn_title ={
    [BackPackConst.tips_btn_type.source]            = TI18N("语言_c_3456"),
    [BackPackConst.tips_btn_type.goods_use]         = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.boss_source]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.drama_new_source]  = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.drama_source]      = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.hero_source]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.skill_source]      = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.form_source]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.call_source]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.artifact_source]   = TI18N("语言_c_763"),
    [BackPackConst.tips_btn_type.redbag]            = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.head]              = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.chenghao]          = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.stone_upgrade]     = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.partner_character] = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.arena_source]      = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.low_treasure]      = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.high_treasure]     = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.sell]              = TI18N("语言_c_1319"),
    [BackPackConst.tips_btn_type.heaven_dial_1]     = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.heaven_dial_2]     = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.heaven_dial_3]     = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.heaven_dial_4]     = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.heaven_dial_5]     = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.fenjie]            = TI18N("语言_c_2958"),
    [BackPackConst.tips_btn_type.hecheng]           = TI18N("语言_c_976"),
    [BackPackConst.tips_btn_type.hecheng2]          = TI18N("语言_c_976"),
    [BackPackConst.tips_btn_type.upgrade_star]      = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.seerpalace_summon] = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.seerpalace_change] = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.halidom]           = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.heaven_book]       = TI18N("语言_c_3094"),
    [BackPackConst.tips_btn_type.heaven_shop]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.item_sell]         = TI18N("语言_c_1319"),
    [BackPackConst.tips_btn_type.hero_reset]         = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.resonate]         = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.elfin_hatch]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.elfin_rouse]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.petard]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.return_action]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.herosoul_shop]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.elfin_egg_synthetic]       = TI18N("语言_c_976"),
    [BackPackConst.tips_btn_type.elfin_summon]       = TI18N("语言_c_796"),
    [BackPackConst.tips_btn_type.use_skill]       = TI18N("语言_c_796"),
...
function BackPackConst.checkIsXianEquip(_type)
    if _type == BackPackConst.item_type.XIAN_WEAPON or    -- 仙级武器
        _type == BackPackConst.item_type.XIAN_SHOE or    -- 仙级鞋子
        _type == BackPackConst.item_type.XIAN_CLOTHES or    -- 仙级衣服
        _type == BackPackConst.item_type.XIAN_HAT then    ---- 仙级头盔
        return true
    end
    return false
end
function BackPackConst.checkIsHolyEquop(_type)
...
function BackPackConst.getBlackQualityColorC4B(quality)
    ...
    if quality == BackPackConst.quality.color then
        return Config.ColorData.data_color4[288]
    elseif quality == BackPackConst.quality.gold then
        return Config.ColorData.data_color4[286]
...
function BackPackConst.getBlackQualityColorStr(quality)
    quality = quality or 0
    if quality == BackPackConst.quality.color then
        return Config.ColorData.data_color_str[288]
    elseif quality == BackPackConst.quality.gold then
        return Config.ColorData.data_color_str[286] 
    elseif quality == BackPackConst.quality.red then
...
--获取家具底(通用ui底上) 对应品质颜色码 格式  c4b(r,g,b,a)
function BackPackConst.getFUnitQualityColorC4B(quality)
    quality = quality or 0
    if quality == BackPackConst.quality.color then
        return Config.ColorData.data_color4[288] 
    elseif quality == BackPackConst.quality.gold then
    ...
    elseif quality == BackPackConst.quality.red then
        return Config.ColorData.data_color4[206] 
    elseif quality == BackPackConst.quality.orange then 
        return Config.ColorData.data_color4[283] 
    elseif quality == BackPackConst.quality.purple then 
        return Config.ColorData.data_color4[185] 
    elseif quality == BackPackConst.quality.blue then 
        return Config.ColorData.data_color4[203] 
...
--背包红点类型
BackPackConst.RedPointType ={
    eHeroChip_All = 1, -- 碎片每天一次性红点
}

-- 符文id
BackPackConst.Artifact = {
    artifact_id_1 = 10454,   --彩虹符文
    artifact_id_2 = 10455,   --闪烁符文
    artifact_id_3 = 10456,   --星耀符文
    artifact_id_4 = 10457,   --星耀符文
}
--------------------------------------------