...
function BackPackConst.checkIsEquip(_type)
    if _type == BackPackConst.item_type.WEAPON or  --武器
		...
		_type == BackPackConst.item_type.SPEC1 or        --特殊装备1
		_type == BackPackConst.item_type.SPEC2 or        --特殊装备2
        ...
        _type == BackPackConst.item_type.GEM1 or
        _type == BackPackConst.item_type.GEM2 or
        _type == BackPackConst.item_type.GEM3 or
        _type == BackPackConst.item_type.GEM4 or
        _type == BackPackConst.item_type.GEM5 or
