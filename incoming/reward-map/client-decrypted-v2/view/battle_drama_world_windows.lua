...
function BattleDramaWorldWindows:getTabType(index)
    if index == 1 then
        return BattleDramaConst.Normal, TI18N("语言_c_243")
    elseif index == 2 then
        return BattleDramaConst.Diffcult, TI18N("语言_c_244")
    end
end
        ...
        if config then
            ...
            for i, v in ipairs(list) do
                ...
                if item then
                    ...
                    item.charpter_label:setString(string.format(TI18N("语言_c_2875"),StringUtil.numToChinese(v.chapter_id)))
