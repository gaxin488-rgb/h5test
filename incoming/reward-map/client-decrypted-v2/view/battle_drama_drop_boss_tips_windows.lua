...
function BattleDramaDropBossItem:ctor(is_bool, is_bools, size)
    ...
    self.unlock_label:setString(TI18N("语言_c_1668"))
    self.item_list = {}
    self.is_lock = true
...
function BattleDramaDropBossItem:setData(data)
    ...
    self.name_label:setString(string.format(TI18N("语言_c_4719"),StringUtil.numToChinese(data.chapter_id),data.name))
end
